  ...
  return (
    <main className="min-h-screen bg-app-gradient px-4 py-8 md:px-6">
      <div className="mx-auto max-w-5xl">
        ...
        <section className="mx-auto max-w-3xl rounded-[36px] border border-slate-200 bg-white p-8 shadow-soft md:p-10">
          <div className="mb-8 text-center">
            <h2 className="text-3xl font-medium text-primary">إنشاء حساب جديد</h2>
          </div>
