  ...
  return (
    <main className="min-h-screen bg-app-gradient px-4 py-6 md:px-6 md:py-8">
      <div className="mx-auto max-w-3xl">
        ...
        <section className="mx-auto max-w-lg rounded-[32px] border border-slate-200 bg-white p-6 shadow-soft md:p-8">
          <div className="mb-6 text-center">
            <h2 className="text-2xl font-semibold text-primary md:text-3xl">تسجيل الدخول</h2>
          </div>
